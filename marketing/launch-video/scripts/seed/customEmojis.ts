// Marketing seed (swapped in for apps/web/src/mock/seed/customEmojis.ts by vite.capture.config.ts).
...
export const customEmojis: CustomEmoji[] = [
  { id: 'ce_orbit', name: 'orbit', url: svg('O', '7c3aed'), createdBy: 'u_shadow', createdAt: ago(10, 'd') },
