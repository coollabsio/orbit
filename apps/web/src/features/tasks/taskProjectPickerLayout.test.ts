...
test('shows the project picker before the All tasks heading without a project rail', async () => {
  ...
  expect(header.indexOf('tasks-project-picker')).toBeLessThan(header.indexOf('>All tasks</span>'))
